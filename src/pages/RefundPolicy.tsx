      ...
      <div className="bg-gradient-to-r from-slate-900 to-brand-charcoal text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center gap-2 mb-4">
            <span className="text-2xl sm:text-3xl sm:text-4xl">💸</span>
          </div>
          <h1 className="text-2xl sm:text-3xl sm:text-4xl md:text-5xl font-bold mb-4">50% Refund Policy</h1>
        ...
        <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-xl border border-white/50 space-y-5 sm:space-y-8">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-foreground">2. Non-Refundable Cases</h2>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-foreground">4. Innovestor's Rights</h2>
            </div>
