...
const Landing = () => {
  ...
  return (
    <div className="bg-black min-h-screen" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* ================================================================ */}
      <Hero3D>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-8 sm:pb-20 text-center">
          ...
          <div
            className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm"
          >
            {[
        ...
        <div className="relative z-10 max-w-3xl mx-auto reveal-on-scroll reveal-item">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full max-w-sm sm:max-w-none mx-auto">
            <Link to="/auth?mode=register" className="w-full sm:w-auto">
              <Button className="text-sm sm:text-base font-semibold rounded-full px-8 sm:px-10 py-4 sm:py-6 w-full sm:w-auto bg-brand-yellow text-brand-charcoal hover:scale-105 transition-all shadow-xl shadow-brand-yellow/30">
                Get Started for Free
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
            <Link to="/auth?mode=login" className="w-full sm:w-auto mt-2 sm:mt-0">
              <Button variant="outline" className="text-sm sm:text-base font-medium rounded-full px-8 sm:px-10 py-4 sm:py-6 w-full sm:w-auto transition-all hover:bg-white/10 border-white/20 text-white/60">
