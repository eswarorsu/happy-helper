...
export function ProfileViewModal({ isOpen, onClose, profile }: ProfileViewModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md bg-white border border-slate-200 shadow-xl">
                <DialogHeader>
                    <DialogTitle className="text-center text-slate-900">Profile Details</DialogTitle>
                </DialogHeader>
